...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function renderCart() {
    ...
    if (cart.length === 0) {
      ...
      cartActions.classList.remove('d-none');  // Use classList to remove d-none
      ...
      cart.forEach(item => {
        ...
        const productHtml = `
          <div class="shopping-product" data-product-id="${item.id}">
            <div class="row align-items-center">
              <div class="col">
                <img src="${item.image}" width="150" height="auto" alt="${item.name}" class="img-fluid rounded-3">
              </div>
              <div class="col">
              ...
              <div class="col d-flex justify-content-between">
                <span class="price">${(item.price * item.quantity).toFixed(2)} جنيه</span>
